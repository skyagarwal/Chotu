      ...
      actions: [
        {
          ...
          executor: 'llm',
          config: {
            systemPrompt: 'Format addresses nicely. Use emojis: 🏠 Home, 🏢 Office, 📍 Other. Numbered list. If empty, say "No addresses saved yet."',
            prompt: 'Addresses: {{saved_addresses}}',
            temperature: 0.3,
            maxTokens: 300,
          },
